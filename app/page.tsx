          ...
          <div id='rule'>
            ...
            >
              ...
              <Typography variant='subtitle1' paddingTop={1} textAlign={'left'}>
                ...
                <br />
                <br />
                また、現在無色透名祭のように、希望者は匿名で投稿できるようなシステムを構築するかを検討しています。
                <br />
                ※無色透名祭様は当投稿祭に一切関与しておりません。
              </Typography>
              <Typography variant='subtitle1' paddingTop={1}>
                このルールは確定ではありません。もしご意見がございましたら、下に記載の匿名意見箱やTwitter(X)のDMから気軽にご連絡ください！
              </Typography>
              ...
              <Typography variant='subtitle1' paddingTop={1} textAlign={'left'}>
                ...
                ⑦ボカロPに運営が許可を取っていても
                <span style={{ fontWeight: 'bold' }}>
                  絵師や動画師などに運営が許可を取っていない場合は、そのボカロPが作ったボカロ曲の絵や動画のパロディを行ってはならない。
                </span>
                （運営も出来るだけ全員の許可を取れるよう尽力する。もし絵師や動画師に許可が取れていないからパロディが出来ないなどの場合は、推薦フォーム(上記記載)から推薦すると良い）
                <br />
                <br />
                ...
                <br />
                <br />
                ⑭タグには「○○ごめんなさいシリーズ」というタグを付けるとパロディをされたボカロPは嬉しい。ただし、任意である。
                <br />
                <br />
              ...
              <Typography variant='subtitle1' paddingTop={1} textAlign={'left'}>
                ...
                <br />
                <br />
                ⑥パロディに関しては、次のTwiPlaに書かれたルールを遵守した曲が投稿されます。そちらもご覧ください。
                <Link href='https://twipla.jp/events/612120' target='_blank' variant='body1'>
                  https://twipla.jp/events/612120
                </Link>
                <br />
                <br />
